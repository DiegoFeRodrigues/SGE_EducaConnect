...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            Aluno aluno10 = new Aluno("Ana", 593150, "Química", "Anninha", "123");
            Aluno aluno11 = new Aluno("João", 593151, "Química", "JP15", "321");
                ...
                switch (escolha) {
                    ...
                    case 4:
                        ...
                        for (Turma turmas : listaTurmas) {
                            System.out.println(turmas.resumoTurma());
                        }
                        break;
                    case 5:     // sair:
                        System.out.println("\nSaindo.\n"); 
